...
namespace Azure.DataApiBuilder.Service.Tests.GraphQLBuilder.Sql
{
    ...
    public class SchemaConverterTests
    {
        ...
        [DataRow(typeof(ushort), INT_TYPE)]
        [DataRow(typeof(int), INT_TYPE)]
        [DataRow(typeof(uint), LONG_TYPE)]
        [DataRow(typeof(long), LONG_TYPE)]
        [DataRow(typeof(ulong), DECIMAL_TYPE)]
        ...
        [DataRow((ushort)1, INT_TYPE, SyntaxKind.IntValue)]
        [DataRow(1, INT_TYPE, SyntaxKind.IntValue)]
        [DataRow(1u, LONG_TYPE, SyntaxKind.IntValue)]
        [DataRow((ulong)1, DECIMAL_TYPE, SyntaxKind.FloatValue)]
